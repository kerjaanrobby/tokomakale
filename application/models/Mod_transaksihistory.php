...
class mod_transaksihistory extends CI_Model{
    ...
    var $col_order = array(null,'tanggalf','gamename', 'produkname','akun','zona','server','status');
    var $col_search = array('tanggalf','gamename', 'produkname','akun','zona','server','status');
    ...
    {
        $this->db->select("transaksi.email,transaksi.trx_id,transaksi.tanggal, date_format(transaksi.tanggal,'%d-%m-%Y %H:%i') as tanggalf, game.nama as gamename, productgame.nama as productname, transaksi.akun, transaksi.zone, transaksi.server, transaksi.status");
    ...
    public function _get_datatables_query()
    {
        ...
        $this->db->select("transaksi.idtransaksi, transaksi.tanggal, transaksi.trx_id, date_format(transaksi.tanggal,'%d-%m-%Y %H:%i') as tanggalf,
