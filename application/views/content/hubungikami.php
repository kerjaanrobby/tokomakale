                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-12 m-t-40 m-b-40">
                            <div class="fix-width">
                                <div class="text-center">
                                    <h2 class="text-title">Hubungi Kami</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fix-width">
                        <div class="row m-t-10 v-top">
                            ...
                            <p>Jika anda memilik pertanyaan silahkan bertanya melalui link berikut</p>
                            <?php foreach($kontak as $k){?>
                            <!-- .col -->
                            <div class="col-md-12 col-sm-12 text-left">
                                <h4 class="text-title"></h4>
                                <a href="<?php echo $k->url;?>"><i class="<?php echo $k->icon;?>"></i> <?php echo $k->displayname;?></a>
                            </div>
                            <?php } ?>
                            <br>
                            <br>
