        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Data Kontak</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div>
                                    <label>Icon</label>
                                    <input class="form-control" name="icon" id="icon" required />
                                </div>
                                <div>
                                    <label>URL</label>
    ...
    <script>
        ...
        function showData(){
            ...
            dttable = table.DataTable({
              ...
              order: [],
              ajax: {
                url: "<?php echo site_url('kontak/datalist')?>",
                type: "POST"
              },
              "columnDefs": [{
        ...
        function editData(id){
            ...
            $.ajax({
                type: "POST",
                url: '<?php  echo base_url(); ?>kontak/datadetail',
                data:{
                id:id
              },
              dataType:'json',
        ...
        function hapus(){
            ...
            $.ajax({
                url: "<?php  echo base_url(); ?>kontak/datahapus",
                type: "POST",
                data:  {id,id},
                dataType:'json', 
                success: function(data)
        ...
        $(function () {
            $('#formInput').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php  echo base_url(); ?>kontak/datasimpan",
                    type: "POST",
