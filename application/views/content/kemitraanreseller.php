                        ...
                        <div class="col-md-12 m-t-40 m-b-40">
                            <div class="fix-width">
                                <div class="text-center">
                                    <h2 class="text-title">Kemitraan Reseller</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fix-width">
                        <div class="row m-t-10 v-top">
                            ...
                            <div class="col-md-12 col-sm-12 text-left">
                                <h4 class="text-title">Reseller</h4>
                                <p><?php echo $k->reseller;?></p>
                            </div>
                            <div class="col-md-12 col-sm-12 text-left">
                                <h4 class="text-title">Reseller VIP</h4>
                                <p><?php echo $k->resellervip;?></p>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
