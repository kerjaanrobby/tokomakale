                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right"> Rp <?php echo number_format($dt->harga-$dt->fee);?> </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <hr>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-6  col-6">
                                            <p><?php echo str_replace('Sukses. ','',$dt->ket);?>
                                            </p>
                                        </div>
                                        <div class="col-sm-6 col-xs-6  col-6">
                                            <div class="pull-right m-t-30 text-right">
                                                <p>Harga: Rp. <?php echo number_format($dt->harga-$dt->fee);?></p>
