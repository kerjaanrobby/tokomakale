        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Data Administrator</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="tableadmin" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Username</th>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div>
                                    ...
                                    <p>Kosongkan jika tidak ingin dirubah</p>
                                </div>
                                <div>
                                    <label>Level</label>
    ...
    <script>
        ...
        function showData(){
            ...
            dttable = table.DataTable({
              ...
              order: [],
              ajax: {
                url: "<?php echo site_url('admin/datalist')?>",
                type: "POST"
              },
              "columnDefs": [{
        ...
        function editData(id){
            ...
            $.ajax({
                type: "POST",
                url: '<?php  echo base_url(); ?>admin/datadetail',
                data:{
                id:id
              },
              dataType:'json',
        ...
        function hapus(){
            ...
            $.ajax({
                url: "<?php  echo base_url(); ?>admin/datahapus",
                type: "POST",
                data:  {id,id},
                dataType:'json', 
                success: function(data)
        ...
        $(function () {
            $('#formInput').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php  echo base_url(); ?>admin/datasimpan",
                    type: "POST",
