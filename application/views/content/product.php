        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Data Product</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="tableproduct" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nomor Urut</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <label>Harga VVIP</label>
                            <input type="number" name="harga_vvip" id="harga_vvip" class="form-control"  required />
                        </div>
                        <div>
                            <label>Status</label>
    ...
    <script type="text/javascript">
        ...
        function showData(){
            ...
            dttable = table.DataTable({
              ...
              order: [],
              ajax: {
                url: "<?php echo site_url('product/datalist')?>",
                type: "POST",
                data: {
                    id:<?php echo $idgame;?>
                }
        ...
        function editData(id){
            ...
            $.ajax({
                type: "POST",
                url: '<?php  echo base_url(); ?>product/datadetail',
                data:{
                id:id
              },
              dataType:'json',
        ...
        function hapus(){
            ...
            $.ajax({
                url: "<?php  echo base_url(); ?>product/datahapus",
                type: "POST",
                data:  {id,id},
                dataType:'json', 
                success: function(data)
        ...
        $(function () {
            $('#formInput').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php  echo base_url(); ?>product/datasimpan",
                    type: "POST",
