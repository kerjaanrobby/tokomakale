                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">Rp <?php echo number_format($dt->topup-$dt->trx_id);?></td>
                                                    <td class="text-right"> Rp <?php echo number_format($dt->topup-$dt->trx_id);?> </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <hr>
                                    ...
                                    <div class="col-sm-8 col-xs-8  col-8">
                                            <p><b>TRANSFER NOMINAL SESUAI SAMPAI 3 DIGIT TERAKHIR</b><br>
                                              ...
                                              Silahkan lakukan pembayaran ke rekening dibawah ini<br>
                                                ...
                                                <br>
                                                Jika anda melakukan Pembayaran Pembelian silahkan konfirmasi melalui <a target="_blank" href="https://wa.me/message/63MUVIGPDQYXA1"> Klik Disini</a> <br>
                                                Jika anda melakukan Pembayaran Deposit Saldo silahkan konfirmasi melalui <a target="_blank" href="https://wa.me/message/63MUVIGPDQYXA1"> Klik Disini</a> 
                                        ...
                                        <div class="col-sm-4 col-xs-4  col-4">
                                            <div class="pull-right m-t-30 text-right">
                                                <p>Harga: Rp. <?php echo number_format($dt->topup-$dt->trx_id);?></p>
