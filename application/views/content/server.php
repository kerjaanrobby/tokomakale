...
<!-- CONTENT -->
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Data Server Game</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Server Game</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="tableservergame" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama Server</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <label>Game</label>
                            <select class="form-control" id="idgame" name="idgame" require>
                                <option value="">Pilih Game</option>
                                <?php foreach($game as $g){?>
                                <option value="<?php echo $g->idgame;?>"><?php echo $g->nama;?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div>
    ...
    <script type="text/javascript">
        ...
        function showData(){
            if ($.fn.DataTable.isDataTable('#tableservergame') ) {
            ...
            dttable = table.DataTable({
              ...
              order: [],
              ajax: {
                url: "<?php echo site_url('server/datalist')?>",
                type: "POST",
              },
              "columnDefs": [{
        ...
        function editData(id){
            ...
            $.ajax({
                type: "POST",
                url: '<?php  echo base_url(); ?>server/datadetail',
                data:{
                id:id
              },
              dataType:'json',
        ...
        function hapus(){
            ...
            $.ajax({
                url: "<?php  echo base_url(); ?>server/datahapus",
                type: "POST",
                data:  {id,id},
                dataType:'json', 
                success: function(data)
        ...
        $(function () {
            $('#formInput').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php  echo base_url(); ?>server/datasimpan",
                    type: "POST",
