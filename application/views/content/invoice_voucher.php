                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $dt->vouchername;?></td>
                                                    <td class="text-center"><?php echo $dt->jumlah;?></td>
                                                <?php if($dt->jenis=="Reseller"){?>
                                                    <td class="text-center">Rp <?php echo number_format($dt->voucherharga_reseller);?></td>
                                                    <td class="text-right"> Rp <?php echo number_format($dt->jumlah*$dt->voucherharga_reseller);?> </td>
                                                <?php }else{?>
                                                    <td class="text-center">Rp <?php echo number_format($dt->voucherharga);?></td>
                                                    <td class="text-right"> Rp <?php echo number_format($dt->jumlah*$dt->voucherharga);?> </td>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-6  col-6">
                                            <p>Silahkan lakukan pembayaran ke rekening dibawah ini<br>
                                                <b>BANK BCA : 0960907248 a/n Anggro Prabowo</b><br>
                                                sistem akan melakukan cek otomatis setiap 2-15 menit<br>
                                                <br>
                                                <b>BANK BNI : 1219402898 a/n Anggro Prabowo</b><br>
                                                <b>BANK BRI : 311601033864530 a/n Anggro Prabowo</b><br>
                                                silahkan konfirmasi manual melalui whatsapp <a target="_blank" href="https://wa.me/+6285641422539"> Disini</a> setelah melakuikan pembayaran
                                            </p>
                                        </div>
                                        <div class="col-sm-6 col-xs-6  col-6">
