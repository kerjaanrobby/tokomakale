...
<!-- CONTENT -->
    <div class="page-wrapper">
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Data Transaksi Point</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Transaksi Point</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modalConfirmReward">
        <div class="modal-dialog">
            <div class="modal-content">          
                <!-- Modal Header -->
                <form action=""  enctype="multipart/form-data" method="POST" class="form-horizontal"  role="formreward">
                <div class="modal-header">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <input type="hidden" name="idtransaksireward" id="idtransaksireward">
                    <h5>Apakah anda yakin akan memberi reward?</h5>
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-success btn-sm" onclick="konfreward()">Ya</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <script type="text/javascript">
        var modal = $("#modalform");
        var modalkonf = $("#modalConfirmReward");
        ...
        function showData(){
            ...
            //   responsive: true,
                ...
                order: [1,"DESC"],
                ajax: {
                    url: "<?php echo site_url('transaksireward/datalist')?>",
                    type: "POST"
                },
                "columnDefs": [{
        ...
        function berireward(idtransaksireward){
            modalkonf.modal();
            $("#idtransaksireward").val(idtransaksireward);
        }
        function konfreward()
        {
            var id = $("#idtransaksireward").val();
            $.ajax({
                url: "<?php  echo base_url(); ?>transaksireward/berireward",
                type: "POST",
                data:  {id,id},
                dataType:'json', 
                success: function(data)
                {
                    ...
                    refreshData();
                    modalkonf.modal('hide');
                    $('#idtransaksireward').val("");
                }         
            });
        }
        ...
        function hapus(){
            ...
            $.ajax({
                url: "<?php  echo base_url(); ?>transaksireward/datahapus",
                type: "POST",
                data:  {id,id},
                dataType:'json', 
                success: function(data)
