<?php echo $head;?>
    <div class="page-wrapper" style="margin-top:-50px;background-color:#ff9028;">
    <?php foreach($game as $g){?>
        <div class="row" id="choose-demo" style="background-color:#ff9028;">
                                                            ...
                                                            <a class="card-body stretched-link text-decoration-none" href="javascript:pilihpayment('<?php echo $pay->kode;?>');">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3 text-left">
                                                                        ...
                                                                        <span class="text-left" style="display:none;" id="feenum-<?php echo $pay->kode;?>"><b></b></span>
                                                                    </div>
                                                                </div>
                                                                <!-- <?php echo $pay->nama;?> -->
                                                            </a>
