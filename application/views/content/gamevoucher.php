                                                        ...
                                                        <div class="card-pay" id="card-pay<?php echo $pay->kode;?>">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="row">
                                                                        <div class="col-sm-5">
                                                                            <span class="text-right text-info" id="hargalabel-<?php echo $pay->kode;?>"style="display:none;">Harga Normal</span><br>
            ...
            $(function(){
                $('#formfield').on('submit', function (e) {
                    ...
                    var htmltext ="<p style='text-align:right'>"+
                                    ...
                                    "</tr>"+
                                    "</table></p>";
                    if((totalbayar=="")||(namavoucher=="")||(paymentname=="")||(buyer_email==""))
                    {
                        if(buyer_email=="")
                        {
                            Swal.fire({
                                title: 'Mohon isi data dengan lengkap',
                                text: "Isi email aktif kamu",
                                icon: 'warning',
                                showCancelButton: false
                            });
                        }
